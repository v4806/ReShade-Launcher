...
namespace COBRA_RLE
{
    ...
    uniform bool UI_StartExposure <
        ui_label     = " 开始曝光";
        ui_tooltip   = "点击开始曝光过程。它将运行指定的秒数然后冻结。\n"
                       "提示：将此绑定到快捷键以方便使用（右键点击按钮）。";
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = false;

    uniform bool UI_ShowProgress <
        ui_label     = " 显示进度";
        ui_tooltip   = "在曝光期间在顶部显示圆形进度条。";
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = false;

    uniform bool UI_ShowGreenOnFinish <
        ui_label     = " 完成时显示绿点";
        ui_tooltip   = "在顶部显示绿点表示曝光已完成并进入预览模式。";
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = false;
    ...
    uniform float UI_ISO <
        ...
        ui_max       = 1600.0;
        ui_step      = 1.0;
        ui_tooltip   = "对光线的敏感度。100 为游戏标准。1600 为 16 倍敏感度。";
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = 100.0;
    ...
    uniform float UI_Gamma <
        ...
        ui_max       = 4.4;
        ui_step      = 0.01;
        ui_tooltip   = "伽马校正值。默认值为 1。此值越高，高光越持久。";
        ui_category  = COBRA_UTL_UI_GENERAL;
    >                = 1.0;
    ...
    uniform int UI_BufferEnd <
        ui_type     = "radio";
        ui_spacing  = 2;
        ui_text     = " 着色器版本：" COBRA_RLE_VERSION;
        ui_label    = " ";
    > ;
    ...
    technique TECH_RealLongExposure <
        ui_label     = "真实长曝光";
        ui_tooltip   = "------关于-------\n"
                       "RealLongExposure.fx 可让您捕捉随时间变化的画面，就像长曝光摄影一样。\n"
                       "它将记录游戏画面持续用户定义的秒数，以创建最终图像，\n"
                       "就像现实中的相机一样。\n\n"
                       "版本:    " COBRA_RLE_VERSION "\n作者:     SirCobra\n合集: CobraFX\n"
