...
uniform int Hints<
	ui_text =
		"\nSMOOTH_BLUR_EDGES 可以从 0 到 5。高于 5 的值"
		"与 5 的效果相同。较高的值会平滑滤镜并"
		"提高整体模糊质量，但会降低性能。";
...
technique VolumetricFogV2 <
	ui_label = "体积雾 V2 - alpha";
	ui_tooltip = "屏幕空间间接体积光照 - 版本 2.0\n"
				 "                    ||作者: Ehsan2077||                    \n"
				 "SSIVL V2 使用不同的技术，因此不需要 TFAA。\n";
>
{
	pass
	{
