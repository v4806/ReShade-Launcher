...
uniform int Hints<
	ui_text = "此着色器目前缺少内置降噪器。\n"
			  "请使用 FXAA 或 TFAA 并相应设置降噪器选项。"
			  "凹凸贴图可能会破坏外观。我正在尝试解决这个问题。";
...
uniform int Shadow_Quality <
	ui_label = "阴影质量";
	ui_type = "combo";
	ui_items = "低 (16 步)\0中 (48 步)\0高 (256 步)\0";
	ui_category = "阴影";
> = 0;
...
technique NGLamps<
	ui_label   = "NiceGuy 灯光";
	ui_tooltip = "NiceGuy 灯光 1.1 Beta\n"
				 "    ||作者: Ehsan2077||  \n";
>
{
	pass GBuffer
