...
uniform int Hints<
	ui_text =
		"强烈建议与 DRME(MotionEstimation.fx) 配合使用\n"
		"此着色器用于配合 qUINT_SSR 和/或 DH_RTGI\n"
		"如果同时使用 SSR 和 DH_RTGI，请将 SSR 放在\n"
		"DH_RTGI 上方以避免伪影。尽管相反的顺序更符合物理规律。\n\n"

		"下载 SSR: https://github.com/martymcmodding/qUINT\n"
		"感谢 Marty\n"
		"qUINT_SSR 推荐设置:\n"
		...
		"下载 DH_RTGI: https://github.com/mj-ehsan/dh-reshade-shaders\n"
		"感谢 Alucard\n"
		"DH_RTGI 推荐设置:\n"
		...
		"下载 DRME: https://github.com/JakobPCoder/ReshadeMotionEstimation\n"
		"感谢 JakobPCoder\n"
		"DRME 推荐设置:\n"
...
uniform float roughfac2 <
	...
	ui_label = "粗糙度曲线";
	ui_tooltip = "整体粗糙度偏移\n"
				 "最终粗糙度还受 SSR 中的 (Surface Relief Height - 推荐: 1)\n"
				 "和 (Surface Relief Scale - 推荐: 0.35) 值影响。";
	ui_min = 0.1;
	ui_max = 2;
> = 0.45;
...
uniform int debug <
	ui_label = "调试模式";
	ui_type = "combo";
	ui_tooltip = "显示着色器的不同层以便更轻松地调整设置";
	ui_items = "无\0粗糙度贴图\0";
	ui_category = "额外";
> = 0;
...
uniform bool GI <
	...
	ui_category = "额外";
	ui_type = "radio";
	ui_tooltip = "如果只想将 Scatter 与 DH_RTGI 配合使用，请开启";
> = 0;
...
< ui_label = "Scatter 顶部";
  ui_tooltip = "                             Scatter FX                             \n"
  			 "                          ||作者: Ehsan2077||                          \n"
			   "||此着色器用于配合 qUINT_SSR 和/或 DH_RTGI||                        \n"
			   "|为 SSR 添加粗糙度，并为两者添加高级降噪器                          |\n"
			   "|使用方法:                                                          |\n"
			   "|1- SSR Companion 顶部                                              |\n"
			   "|2- SSR 和/或 DH_RTGI                                               |\n"
			   "|4- SSR Companion 底部                                              |\n"
			   "|(可选-强烈推荐) 将 DRME(MotionVectors.fx) 放在顶部                 |";>
{
	pass OGColor
	{
