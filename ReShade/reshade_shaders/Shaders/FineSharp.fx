...
uniform float cstr <
	...
	ui_label = "均衡强度";
	ui_tooltip = "基于sstr值的cstr建议设置：sstr=0->cstr=0, sstr=0.5->cstr=0.1, 1.0->0.6, 2.0->0.9, 2.5->1.00, 3.0->1.09, 3.5->1.15, 4.0->1.19, 8.0->1.249";
> = 0.90;

uniform float xstr < __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.00; ui_max = 1.00;
	ui_label = "最终锐化强度";
	ui_tooltip = "XSharpen风格最终锐化的强度。";
> = 0.19;

uniform float xrep < __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.00; ui_max = 1.00;
	ui_label = "瑕疵修复";
	ui_tooltip = "修复最终锐化产生的瑕疵。（-Vit-对原脚本的补充）";
> = 0.25;

uniform float lstr <
	ui_type = "input";
	ui_label = "非线性修改器";
	ui_tooltip = "非线性锐化的修改器";
> = 1.49;
