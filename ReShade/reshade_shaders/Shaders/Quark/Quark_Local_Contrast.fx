...
#define DIVRES(DIVRES_RIV) Width = BUFFER_WIDTH / DIVRES_RIV; Height = BUFFER_HEIGHT / DIVRES_RIV
	...
	uniform int MODE <
		ui_type = "combo";
		ui_items = "拉普拉斯\0反锐化\0遮蔽\0ZN LC\0Quark LC\0";
		ui_label = "增强模式";
		ui_tooltip = "使用的对比度增强方法";
	> = 4;
	...
	uniform float KERNEL_SHAPE <
		...
		ui_max = 1.0;
		ui_label = "细节精度";
		ui_tooltip = "较低的值影响图像的较大部分，较高的值影响更多细节并减少裁剪";
	> = 0.7;
	...
	uniform float GLOBALBRIGHT <
		...
		ui_max = 1.0;
		ui_label = "高光细节";
		ui_tooltip = "增强明亮区域的细节";
	> = 0.0;

	uniform int DEBUG <
		ui_type = "combo";
		ui_items = "无\0图像差异\0遮罩差异\0";
		ui_label = "调试";
	> = 0;
	...
	int Dx9Warning <
		ui_type = "radio";
		ui_text = "糟糕，看起来您正在使用 DX9\n"
			"如果您想在 DX9 游戏中使用 Quark 着色器，请使用 DXVK 或 dgVoodoo2 等包装器";
		ui_label = " ";
		> = 0;
