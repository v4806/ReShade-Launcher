...
uniform float BLOOM_CURVE <
	...
	ui_min = 0.00; ui_max = 10.00;
	ui_label = "泛光曲线";
	ui_tooltip = "较高的值会将泛光效果限制在较亮的光源上。";
> = 1.5;
...
uniform float BLOOM_LAYER_MULT_1 <
	...
	ui_label = "泛光图层1强度";
	ui_tooltip = "该泛光图层的强度。1是最清晰的图层，7是最模糊的图层。";
> = 0.05;
...
uniform float BLOOM_ADAPT_STRENGTH <
	...
	ui_min = 0.00; ui_max = 1.00;
	ui_label = "泛光场景适应灵敏度";
	ui_tooltip = "应用的适应量，0表示所有场景使用相同曝光，1表示完全自动曝光。";
> = 0.5;
uniform float BLOOM_ADAPT_EXPOSURE <
	ui_type = "drag";
	ui_min = -5.00; ui_max = 5.00;
	ui_label = "泛光场景曝光偏差";
	ui_tooltip = "qUINT泛光使用眼睛适应来调整不同场景的泛光强度。\n此参数调整最终场景曝光。";
> = 0.0;
uniform float BLOOM_ADAPT_SPEED <
	ui_type = "drag";
	ui_min = 0.50; ui_max = 10.00;
	ui_label = "泛光场景适应速度";
	ui_tooltip = "眼睛适应数据是通过指数移动平均与上一帧数据创建的。\n此参数控制调整速度。\n较高的值使图像调整更快。";
> = 2.0;
...
< ui_tooltip = "                >> qUINT::泛光 <<\n\n"
			   "泛光是一种着色器，可在明亮的\n"
               "光源和屏幕上的其他发射器周围产生光晕效果。\n"
               "\n泛光由 Marty McFly / Pascal Gilcher 编写"; >
{
    pass
	{
