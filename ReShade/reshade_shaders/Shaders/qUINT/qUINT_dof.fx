...
uniform float2 fADOF_AutofocusCenter <
    ...
    ui_label = "自动对焦中心点";
    ui_tooltip = "自动对焦中心的X和Y坐标。坐标从屏幕左上角开始。";
    ui_category = "对焦设置";
> = float2(0.5, 0.5);
...
uniform float fADOF_ManualfocusDepth <
    ...
    ui_max = 1.0;
    ui_label = "手动对焦深度";
    ui_tooltip = "手动调整的固定对焦深度，禁用自动对焦时使用。";
    ui_category = "对焦设置";
> = 0.001;
...
uniform float fADOF_RenderResolutionMult <
    ...
    ui_max = 1.0;
    ui_label = "渲染尺寸比例";
    ui_tooltip = "散景模糊的分辨率比例。0.5表示屏幕宽度和高度的一半。";
    ui_category = "模糊与质量";
> = 0.5;
...
uniform int iADOF_ShapeVertices <
    ...
    ui_max = 9;
    ui_label = "散景形状顶点数";
    ui_tooltip = "散景内核的顶点数。5=五边形，6=六边形等。";
    ui_category = "散景效果";
> = 6;
...
uniform float fADOF_ShapeCurvatureAmount <
    ...
    ui_max = 1.0;
    ui_label = "散景形状圆度";
    ui_tooltip = "散景内核的圆度。1.0=圆形，0.0=多边形。";
    ui_category = "散景效果";
> = 1.0;
...
< ui_tooltip = "                         >> qUINT::ADOF <<\n\n"
                "它会对焦平面前后场景进行模糊处理，模拟真实镜头的光学特性。\n"
                "丰富的功能设置可以模拟相机产生的各种散景模糊效果。\n"
