...
uniform int BlendM <
    ...
    ui_type = "combo";
    ui_label = "混合模式";
    ui_tooltip = "选择色相和亮度遮罩之间的混合模式。";
    ui_items = "相加\0正片叠底\0";
> = 0;

uniform float blackLevel <
    ui_category = "遮罩设置";
    ui_tooltip = "对最终遮罩的额外黑阶控制。";
    ui_label = "黑阶";
    ui_type = "drag";
...
uniform bool MaskAfterEffects <
    ui_category = "遮罩设置";
    ui_label = "在效果应用后进行遮罩";
	ui_tooltip = "基于在BeforeColorMask和AfterColorMask之间应用着色器后的\n结果颜色进行遮罩，而不是之前的颜色。";
> = false;
