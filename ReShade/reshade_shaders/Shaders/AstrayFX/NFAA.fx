...
uniform int EdgeDetectionType <
	ui_type = "combo";
    ui_items = "亮度边缘检测\0感知亮度边缘检测\0颜色边缘检测\0感知颜色边缘检测\0";
    ui_label = "边缘检测类型";
> = 3;
...
uniform float EdgeDetectionThreshold <
	ui_type = "drag";
    ui_label = "边缘检测阈值";
    ui_tooltip = "被视为边缘的亮度/颜色差异。\n"
                 "如果边缘遮罩遗漏了一些边缘，请尝试稍微降低此值。\n"
                 "默认值为0.063";
...
uniform float UnblurFilterStrength <
	ui_type = "drag";
    ui_label = "反模糊滤镜强度";
    ui_tooltip = "调整边缘遮罩和角落遮罩对比度以过滤不需要的边缘模糊。\n"
                 "如果文字或图标变模糊，请尝试提高此值。\n"
                 "如果边缘仍然太锯齿，请尝试降低此值。\n"
                 "默认值为1.000";
...
uniform float2 BlurSize <
	ui_type = "drag";
    ui_label = "模糊大小";
    ui_tooltip = "调整法线贴图深度以获得更大/更长的边缘模糊。\n"
                 "输入分别是平行于边缘和垂直于边缘的模糊大小。\n"
                 "如果边缘仍然太锯齿，请尝试提高此值。\n"
                 "如果文字或图标变模糊，请尝试降低此值。\n"
                 "默认值为2.000和1.000";
    ui_min = 0.000; ui_max = 4.000; ui_step = 0.001;
...
uniform int DebugOutput <
	ui_type = "combo";
    ui_label = "调试输出";
    ui_items = "无\0边缘遮罩视图\0角落遮罩视图\0法线贴图视图\0模糊前遮罩视图\0模糊后遮罩视图\0";
    ui_tooltip = "边缘遮罩视图显示边缘检测和反模糊滤镜强度。\n"
                 "角落遮罩视图显示角落检测和反模糊滤镜强度。\n"
                 "法线贴图视图显示法线贴图深度，用于模糊大小和模糊方向。\n"
                 "模糊前遮罩视图仅显示将被模糊的边缘。\n"
                 "模糊后遮罩视图仅显示已被模糊的边缘。";
    ui_spacing = 2;
> = 0;
