...
< ui_type = "slider";
	ui_label = "清晰度半径";
	ui_min = 0; ui_max = 4;
	ui_tooltip = "[0|1|2|3|4] 更高的值会增加效果的半径。";
	ui_step = 1.00;
> = 3;
...
< ui_type = "slider";
	...
	ui_tooltip = "模糊半径的额外调整。增加该值会增加半径。";
	ui_step = 1.00;
> = 2.00;
...
<
	...
	ui_tooltip = "混合模式决定清晰度遮罩如何应用到原始图像。";
> = 2;
...
< ui_type = "slider";
	ui_label = "暗部混合阈值";
	ui_min = 0; ui_max = 255;
	ui_tooltip = "低于此值的像素将被排除在效果之外。设置为50以针对中间调。";
	ui_step = 5;
> = 50;
...
< ui_type = "slider";
	ui_label = "亮部混合阈值";
	ui_min = 0; ui_max = 255;
	ui_tooltip = "高于此值的像素将被排除在效果之外。设置为205以针对中间调。";
	ui_step = 5;
> = 205;
...
<
	ui_label = "显示混合遮罩";
	ui_tooltip = "用于混合设置的遮罩。效果不会应用于黑色覆盖的区域。";
> = false;
...
< ui_type = "slider";
	ui_label = "亮部光晕强度";
	ui_min = 0.00; ui_max = 1.00;
	ui_tooltip = "调整亮部光晕的强度。";
> = 0.000;

uniform bool ClarityViewMask
<
	ui_label = "显示遮罩";
	ui_tooltip = "遮罩是产生效果的关键。在调整时查看它可以更好地了解您的更改将如何影响图像。";
> = false;
