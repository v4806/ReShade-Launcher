...
// DEBUG 
    ...
    uniform int iDebug <
        ...
        ui_type = "combo";
        ui_label = "显示";
        ui_items = "输出\0全局光照\0环境光遮蔽\0屏幕空间反射\0粗糙度\0深度\0法线\0天空\0运动\0环境光\0厚度\0";
        ui_tooltip = "调试着色器的中间步骤";
    > = 0;
...
// COMMMON RT
    ...
    uniform int iCheckerboardRT <
        ...
        ui_type = "combo";
        ui_label = "棋盘光线追踪";
        ui_items = "已禁用\0每帧一半\0每帧四分之一\0";
        ui_tooltip = "每像素一条光线，每2像素1条光线或每4像素1条光线\n"
                    "较低=更少鬼影，性能较低\n"
                    "较高=更多鬼影，更少噪点，更好性能\n"
                    "对性能有正面影响";
    > = 0;
    ...
    uniform int iFrameAccu <
        ...
        ui_min = 1; ui_max = 16;
        ui_step = 1;
        ui_tooltip = "定义随时间累积的帧数。\n"
                    "较低=运动中鬼影更少，噪点更多\n"
                    "较高=运动中鬼影更多，噪点更少\n"
                    "/!\\ 如果禁用运动检测，请将此值降低到3，除非您有非常高的帧率";
    > = 12;
...
// AO
    ...
    uniform float fAODarkProtect <
        ...
        ui_min = 0.0; ui_max = 1.0;
        ui_step = 0.01;
        ui_tooltip = "保护暗区域以避免完全黑暗和无法游玩的部分";
    > = 0.25;
...
// Denoising
    ...
    uniform int iSmoothStep <
        ...
        ui_min = 1; ui_max = 8;
        ui_step = 1;
        ui_tooltip = "通过跳过平滑中的像素并使用较低质量LOD来折衷平滑。\n"
                    "较高:更少噪点，可能平滑不应混合的表面\n"
                    "这对性能没有影响 :)";
    > = 4;
    */
