...
<
	ui_category = "泛光 - 高级";
	ui_label = "采样质量";
	ui_tooltip = "指定高斯模糊的采样数量。"
	"\n" "\n" "中 - 5, 高 - 7, 极高 - 11, Overkill - 13\n"
	"\n" "\n" "默认: 中";
	ui_category_closed = true;
	ui_type = "combo";
	ui_items = "中\0高\0极高\0Overkill\0";  // 0 - Medium, 1 - High, 2 - Ultra, 3 - Overkill
> = Medium;
