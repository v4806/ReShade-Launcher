...
#define CATEGORY "雾气物理属性" ///////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////
UI_INT_S (DISTANCE, "密度", "决定雾气的表观厚度。", 1, 100, 75, 0)
#define UI_DIST pow(DISTANCE * 0.01, 0.125)
UI_INT_S (HIGHLIGHT_DIST, "高光穿透距离", "控制高光能穿透雾气的距离。", 0, 100, 100, 1)

UI_COLOR (FOG_TINT, "雾气颜色", "", 0.4, 0.45, 0.5, 5)
UI_COMBO (AUTO_COLOR, "雾气颜色模式", "", 2, 1,
    "精确雾气颜色\0"
    "保留场景亮度\0"
    "使用模糊场景亮度\0")
UI_INT_S (WIDTH, "光线散射", "控制光晕宽度。需要启用模糊场景亮度。", 0, 100, 50, 1)
#undef  CATEGORY /////////////////////////////////////////////////////////////////////////////////

#if (ENABLE_MISC_CONTROLS != 0)
#define CATEGORY "其他控制" /////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////
UI_INT_S (FOG_SAT, "雾气饱和度增强", "（非写实）增强雾气的色彩丰富度", 0, 100, 0, 0)
UI_INT_S (BLUR_WIDTH, "模糊宽度", "决定用于生成雾气的模糊大小。", 50, 100, 100, 1)
UI_INT_S (BLEND, "整体混合", "（非写实）简单地将雾气与原始图像混合。\n"
                                  "低于100并不完全正确，但\n"
                                  "此控制项为需要的用户提供。", 0, 100, 100, 1)
#undef  CATEGORY /////////////////////////////////////////////////////////////////////////////////
#endif
...
// TECHNIQUES /////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////////
TECHNIQUE    (ATMOSPHERE,   "ATMOSPHERE", "大气雾效",
