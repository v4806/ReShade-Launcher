...
uniform int screenLinesNum <
	...
	ui_step = 1;
	ui_label = "屏幕分辨率 [VHSPro]";
	ui_tooltip = "屏幕分辨率（以行为单位）。";
> = BUFFER_HEIGHT;

uniform bool VHS_Bleed <
	ui_label = "色彩溢出 [VHSPro]";
	ui_tooltip = "启用光束屏幕色彩溢出（使图像模糊）。";
> = true;

uniform int VHS_BleedMode <
	ui_type = "combo";
	ui_items = "三相位\0旧三相位\0两相位（慢）\0三相位（RetroArch）\0两相位（RetroArch）\0";
	ui_label = "色彩溢出模式 [VHSPro]";
	ui_tooltip = "在不同的色彩溢出模式之间切换。";
> = 0;
...
uniform bool VHS_FishEye_Hyperspace <
	ui_label = "鱼眼超空间 [VHSPro]";
	ui_tooltip = "将曲率更改为类似某种超空间扭曲的效果。";
> = false;
...
uniform float cutoffFadeX <
	...
	ui_min = 0.0;
	ui_max = 50.0;
	ui_label = "鱼眼水平截断渐变 [VHSPro]";
	ui_tooltip = "水平渐变截断的大小。";
> = 25.0;
...
uniform float cutoffFadeY <
	...
	ui_min = 0.0;
	ui_max = 50.0;
	ui_label = "鱼眼垂直截断渐变 [VHSPro]";
	ui_tooltip = "垂直渐变截断的大小。";
> = 25.0;
...
uniform float vignetteSpeed <
	...
	ui_min = 0.0;
	ui_max = 5.0;
	ui_label = "暗角脉冲速度 [VHSPro]";
	ui_tooltip = "暗角脉冲的速度。（设置为0使其停止脉冲）";
> = 1.0;
...
uniform int noiseLinesNum <
	...
	ui_min = 1;
	ui_max = BUFFER_HEIGHT;
	ui_label = "垂直分辨率 [VHSPro]";
	ui_tooltip = "噪点分辨率（以行为单位）。\n\n要使用此设置，请安装由cot6创建的\"UIBind\"插件。\n\n或者，您必须通过调整noiseLinesRes在下面的预处理器定义中设置此值";
...
uniform float noiseQuantizeX <
	...
	ui_min = 0.0;
	ui_max = 1.0;
	ui_label = "噪点量化 X [VHSPro]";
	ui_tooltip = "使噪点变长或变短。";
> = 0.0;

uniform bool VHS_FilmGrain <
	ui_label = "胶片颗粒 [VHSPro]";
	ui_tooltip = "在屏幕上启用胶片颗粒效果。";
> = false;
...
uniform float filmGrainAmount <
	...
	ui_min = 0.0;
	ui_max = 0.1;
	ui_label = "胶片颗粒透明度 [VHSPro]";
	ui_tooltip = "胶片颗粒的强度。";
> = 0.016;

uniform bool VHS_YIQNoise <
	ui_label = "信号噪点 [VHSPro]";
	ui_tooltip = "向YIQ信号添加噪点，产生粉红色（或绿色）噪点。";
> = true;

uniform int signalNoiseType <
	ui_type = "combo";
	ui_items = "类型1\0类型2\0类型3\0";
	ui_label = "信号噪点类型 [VHS Pro]";
> = 0;
...
uniform float signalNoisePower <
	...
	ui_min = 0.0;
	ui_max = 1.0;
	ui_label = "信号噪点强度 [VHSPro]";
	ui_tooltip = "信号噪点的强度。较高的值会使其变绿，较低的值会使其更粉红。";
> =  0.83;

uniform bool VHS_LineNoise <
	ui_label = "线条噪点 [VHSPro]";
	ui_tooltip = "在图像中启用闪烁的线条噪点。";
> = true;
...
uniform float lineNoiseSpeed <
	...
	ui_min = 0.0;
	ui_max = 10.0;
	ui_label = "线条噪点速度 [VHSPro]";
	ui_tooltip = "线条噪点闪烁延迟的速度。";
> = 5.0;

uniform bool VHS_TapeNoise <
	ui_label = "磁带噪点 [VHSPro]";
	ui_tooltip = "添加类似旧VHS磁带中的滚动噪点。";
> = true;
...
uniform float tapeNoiseTH <
	...
	ui_min = 0.0;
	ui_max = 1.5;
	ui_label = "磁带噪点量 [VHSPro]";
	ui_tooltip = "图像中磁带噪点的强度。";
> = 0.63;
...
uniform float tapeNoiseAmount <
	...
	ui_min = 0.0;
	ui_max = 1.5;
	ui_label = "磁带噪点透明度 [VHSPro]";
	ui_tooltip = "图像中磁带噪点的量。";
> = 0.05;
...
uniform float tapeNoiseSpeed <
	...
	ui_min = -1.5;
	ui_max = 1.5;
	ui_label = "磁带噪点速度 [VHSPro]";
	ui_tooltip = "磁带噪点的滚动速度。";
> = 1.0;

uniform bool VHS_ScanLines <
	ui_label = "扫描线 [VHSPro]";
	ui_tooltip = "启用电视/CRT扫描线";
> = false;
...
uniform float scanLineWidth <
	...
	ui_min = 0.0;
	ui_max = 20.0;
	ui_label = "扫描线宽度 [VHSPro]";
	ui_tooltip = "扫描线的宽度";
> = 10.0;

uniform bool VHS_LinesFloat	<
	ui_label = "线条浮动 [VHSPro]";
	ui_tooltip = "使屏幕线条向上或向下浮动。在低屏幕行数分辨率下效果最佳。";
> = false;
...
uniform float linesFloatSpeed <
	...
	ui_min = -3.0;
	ui_max = 3.0;
	ui_label = "线条浮动速度 [VHSPro]";
	ui_tooltip = "浮动线条的速度（和方向）。";
> = 1.0;

uniform bool VHS_Stretch <
	ui_label = "拉伸噪点 [VHSPro]";
	ui_tooltip = "启用在图像上下滚动的拉伸噪点，模拟VHS磁带的磁干扰。";
> = true;

uniform bool VHS_Jitter_H <
	ui_type = "bool";
	ui_label = "隔行扫描 [VHSPro]";
	ui_tooltip = "启用隔行扫描。";
> = true;
...
uniform float jitterVSpeed <
	...
	ui_min = 0.0;
	ui_max = 5.0;
	ui_label = "抖动速度 [VHSPro]";
	ui_tooltip = "垂直抖动噪点的速度。";
> = 1.0;

uniform bool VHS_Twitch_H <
	ui_label = "水平抽动 [VHSPro]";
	ui_tooltip = "使图像在特定时间间隔内水平抽动。";
> = false;
...
uniform float twitchHFreq <
	...
	ui_min = 0.0;
	ui_max = 5.0;
	ui_label = "水平抽动频率 [VHSPro]";
	ui_tooltip = "图像水平抽动的时间频率。";
> = 1.0;

uniform bool VHS_Twitch_V <
	ui_label = "垂直抽动 [VHSPro]";
	ui_tooltip = "使图像在特定时间间隔内垂直抽动。";
> = false;
...
uniform float twitchVFreq <
	...
	ui_min = 0.0;
	ui_max = 5.0;
	ui_label = "垂直抽动频率 [VHSPro]";
	ui_tooltip = "图像垂直抽动的时间频率。";
> = 1.0;

uniform bool VHS_SignalTweak <
	ui_label = "信号调整 [VHSPro]";
	ui_tooltip = "调整YIQ信号的值。";
> = false;
...
uniform float signalAdjustY <
	...
	ui_min = -0.25;
	ui_max = 0.25;
	ui_label = "信号偏移 Y [VHSPro]";
	ui_tooltip = "偏移/调整信号的亮度部分。";
> = 0.0;
uniform float signalAdjustI <
	ui_type = "slider";
	ui_min = -0.25;
	ui_max = 0.25;
	ui_label = "信号偏移 I [VHSPro]";
	ui_tooltip = "偏移/调整信号的色度部分。";
> = 0.0;
...
uniform float signalShiftY <
	...
	ui_min = -2.0;
	ui_max = 2.0;
	ui_label = "信号调节 Y [VHSPro]";
	ui_tooltip = "调节信号的亮度部分。";
> = 1.0;
...
uniform float signalShiftI <
	...
	ui_min = -2.0;
	ui_max = 2.0;
	ui_label = "信号调节 I [VHSPro]";
	ui_tooltip = "调节信号的色度部分。";
> = 1.0;
...
uniform float gammaCorection <
	...
	ui_min = 0.0;
	ui_max = 2.0;
	ui_label = "信号伽马校正 [VHSPro]";
	ui_tooltip = "对图像进行伽马校正。";
> = 1.0;

uniform bool VHS_Feedback <
	ui_label = "荧光尾迹 [VHSPro]";
	ui_tooltip = "启用来自老式CRT显示器的荧光尾迹效果。";
> = false;
...
uniform float feedbackFade <
	...
	ui_min = 0.0;
	ui_max = 1.0;
	ui_label = "荧光衰减 [VHSPro]";
	ui_tooltip = "荧光尾迹的衰减时间。";
> = 0.82;
...
uniform float feedbackThresh <
	...
	ui_min = 0.0;
	ui_max = 1.0;
	ui_label = "输入截断 [VHSPro]";
	ui_tooltip = "尾迹的截断。";
> = 0.1;

uniform float3 feedbackColor <
	ui_type = "color";
	ui_label = "荧光尾迹颜色 [VHSPro]";
	ui_tooltip = "尾迹的颜色。";
> = float3(1.0,0.5,0.0);

uniform bool feedbackDebug <
	ui_type = "bool";
	ui_label = "调试尾迹 [VHS Pro]";
	ui_tooltip = "启用仅显示荧光尾迹的可视化。";
> = false;

uniform bool VHS_Filter <
	ui_type = "bool";
	ui_label = "线性过滤 [VHSPro]";
	ui_tooltip = "对图像进行线性过滤，提高质量。\n\n要使用此设置，请安装由cot6创建的\"UIBind\"插件。\n\n或者，您可以通过将VHSLINEARFILTER调整为1在下面的预处理器定义中启用线性过滤";
