...
uniform int gGaussEffect <
    ui_label = "高斯效果";
    ui_type = "combo";
    ui_items="关\0模糊\0反锐化遮罩 (消耗大)\0泛光\0素描\0仅效果图像\0";
> = 1;

uniform float gGaussStrength <
    ui_label = "高斯强度";
    ui_tooltip = "混合到最终图像中的效果量。";
    ui_type = "slider";
    ui_min = 0.0;
    ui_max = 1.0;
    ui_step = 0.001;
