...
uniform float DOF_RADIUS <
	ui_label = "景深 - 半径";
	ui_tooltip = "1.0 = 像素完美半径。高于1.0的值可能会产生伪影。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 10.0;
	> = 1.0;
uniform float DOF_NEAR_STRENGTH <
	ui_label = "景深 - 近景模糊强度";
	ui_tooltip = "相机和焦点之间的模糊强度。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0;
	> = 0.5;
uniform float DOF_FAR_STRENGTH <
	ui_label = "景深 - 远景模糊强度";
	ui_tooltip = "焦点之后的模糊强度。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0;
	> = 1.0;
uniform float DOF_FOCAL_RANGE <
	ui_label = "景深 - 焦距范围";
	ui_tooltip = "与焦距曲线一起，控制多少区域处于对焦状态";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.0;
uniform float DOF_FOCAL_CURVE <
	ui_label = "景深 - 焦距曲线";
	ui_tooltip = "1.0 = 无曲线。高于此值会使更多物体对焦，较低值会产生微距效果。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0;
	> = 1.0;
uniform float DOF_HYPERFOCAL <
	ui_label = "景深 - 超焦距范围";
	ui_tooltip = "当焦点超过此点时，远处的所有物体都会对焦。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.9;
uniform float DOF_BLEND <
	ui_label = "景深 - 混合曲线";
	ui_tooltip = "控制景深纹理和原始图像之间的混合曲线。使用此选项避免景深开始处的伪影";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.3;
uniform float DOF_BOKEH_CONTRAST <
	ui_label = "景深 - 散景 - 对比度";
	ui_tooltip = "散景和模糊区域的对比度。使用非常小的值。";
	ui_type = "slider";
	ui_min = -1.0; ui_max = 1.0;
	> = 0.04;
uniform float DOF_BOKEH_BIAS <
	ui_label = "景深 - 散景 - 偏移";
	ui_tooltip = "0.0 = 无散景，1.0 = 自然散景，2.0 = 强制散景。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0;
	> = 1.0;
uniform float DOF_MANUAL_FOCUS <
	ui_label = "景深 - 手动对焦";
	ui_tooltip = "仅在手动对焦开启时有效。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.5;
uniform float DOF_FOCUS_X <
	ui_label = "景深 - 自动对焦 X";
	ui_tooltip = "屏幕上要对焦的水平点。0.5 = 中间";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.5;
uniform float DOF_FOCUS_Y <
	ui_label = "景深 - 自动对焦 Y";
	ui_tooltip = "屏幕上要对焦的垂直点。0.5 = 中间";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.5;
uniform float DOF_FOCUS_SPREAD <
	ui_label = "景深 - 自动对焦扩散";
	ui_tooltip = "对焦取5个点的平均值，这是它们的距离。使用低值可获得精确对焦。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 0.5;
	> = 0.05;
uniform float DOF_FOCUS_SPEED <
	ui_label = "景深 - 自动对焦速度";
	ui_tooltip = "焦点变化发生的速度。1.0 = 一秒。高于1.0的值更快，低于1.0更慢。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 10.0;
	> = 1.0;
uniform float DOF_SCRATCHES_STRENGTH <
	ui_label = "景深 - 镜头划痕强度";
	ui_tooltip = "划痕效果的强度。低值更好，因为这在明亮场景中很明显。";
	ui_type = "slider";
	ui_min = 0.0; ui_max = 1.0;
	> = 0.15;
uniform int DOF_DEBUG <
	ui_label = "景深 - 调试 - 显示焦点";
	ui_tooltip = "黑色为对焦区域，红色为模糊区域。";
	ui_type = "combo";
	ui_items = "否\0是\0";
	> = 0;
