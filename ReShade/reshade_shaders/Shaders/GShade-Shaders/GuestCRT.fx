...
uniform int ResolutionX <
	ui_type = "input";
	ui_label = "分辨率 X";
	ui_tooltip = "要使用此设置，请安装cot6创建的\"UIBind\"插件。\n\n或者，您可以在下方的预处理器定义中通过调整ResolutionXGCRT来指定所需的分辨率宽度";
...
uniform int ResolutionY <
	ui_type = "input";
	ui_label = "分辨率 Y";
	ui_tooltip = "要使用此设置，请安装cot6创建的\"UIBind\"插件。\n\n或者，您可以在下方的预处理器定义中通过调整ResolutionYGCRT来指定所需的分辨率高度";
...
uniform uint shadowMask <
	...
	ui_max = 7;
	ui_step = 1;
	ui_label = "CRT遮罩: 1:CGWG, 2-5:Lottes, 6-7:'特丽珑'";
> = 1;
