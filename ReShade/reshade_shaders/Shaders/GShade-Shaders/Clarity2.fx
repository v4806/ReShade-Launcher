...
<
	...
	ui_min = 0; ui_max = 4;
	ui_label = "清晰度半径";
	ui_tooltip = "[0|1|2|3|4] 较高的值将增加效果的半径。";
	ui_step = 1.00;
> = 3;
...
<
	ui_type = "combo";
	ui_items = "\柔光\0叠加\0强光\0正片叠底\0亮光\0线性光\0相加\0";
	ui_label = "混合模式";
	ui_tooltip = "混合模式决定如何将清晰度遮罩应用于原始图像";
> = 2;
...
<
	...
	ui_min = 0; ui_max = 255;
	ui_label = "深色排除";
	ui_tooltip = "低于此值的任何像素将被排除在效果之外。设置为50以针对中间调。";
	ui_step = 5;
> = 50;
...
<
	...
	ui_min = 0; ui_max = 255;
	ui_label = "浅色排除";
	ui_tooltip = "高于此值的任何像素将被排除在效果之外。设置为205以针对中间调。";
	ui_step = 5;
> = 205;
...
<
	...
	ui_label = "抖动强度";
	ui_tooltip = "向ClarityMask添加抖动以帮助减少色带";
> = 1.0;
...
<
	ui_type = "combo";
	ui_items = "\无\0清晰度遮罩\0混合遮罩\0模糊\0";
	ui_label = "调试模式";
	ui_tooltip = "调整设置时可能有用的一些选项";
> = 0;
#endif
...
<
	ui_type = "combo";
	ui_items = "\必须重新加载ReShade才能激活这些设置。\0UseClarityDebug=1 激活调试选项。\0ClarityRGBMode=1 以RGB模式而非亮度模式运行Clarity。\0";
	ui_label = "预处理器定义";
	ui_tooltip = "这些设置可以添加到设置选项卡中的预处理器定义中。";
> = 0;
