...
uniform int2 display_size <
	ui_type = "input";
	ui_label = "显示尺寸";
	ui_tooltip = "虚拟屏幕尺寸（像素）";
> = int2(320, 240);

uniform float2 pixel_mask_scale <
	ui_type = "input";
	ui_label = "像素遮罩缩放";
	ui_tooltip = "像素遮罩图像重复次数";
> = float2(160, 90);
...
uniform float luma_sharpen <
	...
	ui_max = 4.0;
	ui_label = "亮度锐化";
	ui_tooltip = "对亮度信号应用锐化滤镜";
> = 1.0;

uniform bool EnableTVCurvature <
	ui_label = "启用电视曲率";
	ui_tooltip = "启用CRT曲率效果";
> = true;
...
uniform int3 colorbits <
	...
	ui_max = 8;
	ui_label = "色彩位数";
	ui_tooltip = "每个颜色通道的位数";
> = int3( 8, 8, 8 );

uniform bool EnableRollingFlicker <
	ui_label = "启用滚动闪烁";
	ui_tooltip = "启用闪烁效果以模拟电视和摄像机垂直同步不匹配";
> = true;
