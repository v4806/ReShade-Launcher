...
uniform float maskstr <
	...
	ui_label = "遮罩强度 遮罩: 0, 5-12";
	ui_tooltip = "遮罩强度 遮罩: 0, 5-12";
> = 0.33;

uniform float mcut <
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0; ui_step = 0.05;
	ui_label = "遮罩低强度 (遮罩: 0, 5-12)";
	ui_tooltip = "遮罩低强度 (遮罩: 0, 5-12)";
> = 1.10;
...
uniform int mask_layout <
	ui_type = "slider";
	ui_min = 0; ui_max = 1;
	ui_label = "遮罩布局: RGB或BGR (检查LCD面板)";
	ui_tooltip = "遮罩布局: RGB或BGR (检查LCD面板)";
> = 0;

uniform float maskDark <
	ui_type = "slider";
	ui_min = 0.0; ui_max = 2.0; ui_step = 0.05;
	ui_label = "遮罩暗部 (遮罩 1-4)";
	ui_tooltip = "遮罩暗部 (遮罩 1-4)";
> = 0.50;
