...
<
	...
	ui_label = "模糊半径";
	ui_min = 1; ui_max = 4;
	ui_tooltip = "1 = 3x3掩码, 2 = 5x5掩码, 3 = 7x7掩码, 4 = 9x9掩码。如需更多模糊效果，请在预处理器定义中添加SurfaceBlurIterations=2或SurfaceBlurIterations=3";
> = 1;
...
<
	...
	ui_tooltip = "模糊半径的额外调整。小于1.00的值会减少模糊半径。";
> = 1.000;
...
<
	...
	ui_tooltip = "调整边缘检测的强度。较低的值会将较细的边缘排除在模糊之外。";
> = 0.500;
