...
uniform bool bSmoothNormals <
    ui_category = "表面与法线";
    ui_label = "启用平滑法线";
    ui_tooltip = "平滑计算的表面法线以减少块状伪影，特别是在平坦表面上。";
> = true;
...
uniform bool EnableTemporal <
    ui_category = "时间滤波";
    ui_label = "启用时间累积";
    ui_tooltip = "将当前帧的反射与前几帧混合，以减少噪点和闪烁。";
> = true;
...
uniform float AccumFramesSG <
    ...
    ui_category = "时间滤波";
    ui_label = "时间累积帧数";
    ui_tooltip = "累积的帧数。值越高越平滑，但可能导致移动物体上出现更多重影。";
> = 4.0;

uniform int BlendMode <
    ui_type = "combo";
    ui_items = "叠加\0滤色\0透明度混合\0";
    ui_category = "混合与输出";
    ui_label = "混合模式";
    ui_tooltip = "最终反射与原始图像的混合方式。";
> = 1;
...
uniform bool EnableACES <
    ui_category = "混合与输出";
    ui_label = "启用 ACES 色调映射";
    ui_tooltip = "对反射应用 ACES 色调映射，获得更具电影感的效果。";
> = false;

uniform bool AssumeSRGB <
    ui_category = "混合与输出";
    ui_label = "假设 sRGB 输入";
    ui_tooltip = "假设输入颜色在 sRGB 空间中并将其线性化。除非你知道游戏输出非线性颜色，否则请保持禁用。";
> = false;
...
uniform float RenderScale <
    ...
    ui_category = "性能与质量";
    ui_label = "渲染比例";
    ui_tooltip = "以较低分辨率渲染反射以提高性能。0.5 表示一半分辨率。";
> = 0.8;
...
uniform float VerticalFOV <
    ...
    ui_category = "高级设置";
    ui_label = "垂直视场角";
    ui_tooltip = "设置为游戏的垂直视场角以获得准确的投影计算。";
> = 37.0;

uniform int ViewMode <
    ui_type = "combo";
    ui_items = "无\0运动矢量\0最终反射\0法线\0深度\0原始反射\0";
    ui_category = "调试";
    ui_label = "调试视图模式";
> = 0;
...
technique SSRT < ui_tooltip = "屏幕空间光线追踪反射"; >
{
