...
uniform int ViewMode
    <
        ...
        ui_type = "combo";
        ui_label = "视图模式";
        ui_tooltip = "选择 SSAO 的视图模式";
        ui_items = "无\0AO 调试\0深度\0天空调试\0法线调试\0";
    >
    = 0;
