...
uniform float THICKNESS_THRESHOLD <
    ...
    ui_category = "主要设置";
    ui_label = "厚度阈值";
    ui_tooltip = "决定光线穿过表面前表面的厚度。防止自反射伪影。";
> = 0.01;
...
uniform float Metallic <
    ...
    ui_category = "表面与材质";
    ui_label = "金属度";
    ui_tooltip = "控制表面的金属程度。0.0 用于电介质(塑料、木材),1.0 用于金属。";
> = 0.2;
...
uniform float Roughness <
    ...
    ui_category = "表面与材质";
    ui_label = "粗糙度";
    ui_tooltip = "控制表面粗糙度。0.0 是完美的镜面,1.0 是非常粗糙的(漫反射)。";
> = 0.25;
...
uniform float SobelEdgeThreshold <
    ui_label = "Sobel 边缘阈值";
    ui_tooltip = "设置凹凸贴图生效的最小边缘强度。有助于减少平坦表面上的噪点。";
    __UNIFORM_DRAG_FLOAT1
    ui_category = "表面与材质";
    ui_min = 0.0; ui_max = 1.0; ui_step = 0.01;
> = 0.03;
...
uniform int Quality <
    ...
    ui_category = "性能与质量";
    ui_label = "质量预设";
    ui_tooltip = "在更高质量的光线追踪和更快的预设之间选择。";
> = 0;
...
uniform bool EnableGlossy <
    ui_category = "光泽反射";
    ui_label = "启用光泽反射";
    ui_tooltip = "模拟非完美光滑表面上的反射,产生模糊/光泽效果。";
> = true;
...
uniform int GlossySamples <
    ...
    ui_category = "光泽反射";
    ui_label = "光泽采样数";
    ui_tooltip = "模糊效果的采样数量。值越高质量越好,但速度越慢。";
> = 10;
...
uniform bool EnableTAA <
    ui_category = "时间滤波";
    ui_label = "启用时间重投影";
    ui_tooltip = "使用时间重投影将当前帧的反射与前几帧混合,以减少噪点和闪烁。";
> = true;
...
uniform float FeedbackFactor <
    ...
    ui_category = "时间滤波";
    ui_label = "时间反馈";
    ui_tooltip = "控制混合前一帧的程度。值越高越平滑,但可能导致更多重影。";
> = 0.99;
...
uniform float OrientationThreshold <
    ...
    ui_category = "高级设置";
    ui_label = "方向阈值";
    ui_tooltip = "基于法线向量控制检测地板/墙壁/天花板的灵敏度。值越低越严格。";
> = 0.90;
...
uniform float GeoCorrectionIntensity <
    ...
    ui_category = "高级设置";
    ui_label = "几何校正强度";
    ui_tooltip = "根据颜色数据微调表面法线,以校正轻微的几何不准确性。";
> = -0.01;
...
uniform int ViewMode <
    __UNIFORM_COMBO_INT1
    ui_items = "无\0运动矢量\0最终反射\0法线\0深度\0原始低分辨率反射\0反射遮罩\0";
    ui_category = "调试";
    ui_label = "调试视图模式";
> = 0;
