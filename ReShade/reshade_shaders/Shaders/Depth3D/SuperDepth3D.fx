...
uniform int SuperDepth3D <
	...
	uniform float Divergence <
		...
		ui_label =  "·深度调整·"; 
		ui_tooltip =  "增加左右图像之间的差异，让您体验深度效果。\n"
					  "从双目获取深度信息的过程称为立体视觉。\n"
					  "默认值为50%，最大值为125%。";
		ui_category = "发散度与分离度";
	> = 50;
	...
	> = DF_Y;
		...
		ui_label =  "·零视差距离·"; 
		ui_tooltip =  "ZPD（零视差距离）控制屏幕弹出效果的焦距。\n"
					  "对于FPS游戏，保持ZPD较低，这样您的枪不会弹出屏幕。\n"
					  "ZPD的默认值为0.025。";
		#if !NPW
		ui_category_closed = true;
		#endif
	...
	uniform float ZPD_Balance <
		...
		ui_label = " ZPD平衡";
		ui_tooltip = "在ZPD深度和场景深度之间进行平衡。\n"
					 "改变3D效果的优先级。\n"
					 "默认值为0代表ZPD深度，0.5代表增强场景深度。";
		ui_category = "会聚";
	> = DF_Z;
	...
	uniform int Auto_Balance_Ex <
		ui_type  = "combo";
		ui_items = "关\0Left\0中心\0Right\0Center Wide\0Left Wide\0Right Wide\0";
//		ui_items = "关\0Left\0中心\0Right\0Center Wide\0Left Wide\0Right Wide\0Eye Tracker\0Eye Tracker Alt\0";
		ui_label = " ZPD自动平衡";
		ui_tooltip = "在ZPD深度和场景深度之间自动平衡。\n"
					 "默认为关闭。";
		ui_category = "会聚";
	> = ABE;
	#endif
	uniform int ZPD_Boundary <
		...
		ui_label = " ZPD边界检测";
		ui_tooltip = "此选项提供额外的边界条件来检测ZPD入侵。\n"
					 "默认为关闭。";
		ui_category = "会聚";
	> = DE_X;
	...
	uniform float2 ZPD_Boundary_n_Fade <
		...
		ui_label = " ZPD缩放器¹与过渡";
		ui_tooltip = "此选项提供额外的边界条件来缩放ZPD级别一。\n"
					 "第二个选项让您调整级别一和二的过渡时间。\n"
					 "仅在启用边界检测时有效。";
		ui_category = "会聚";
	> = float2(DE_Y,DE_Z);
	...
	uniform float2 ZPD_Boundary_n_Cutoff_A <
		...
		ui_min = 0.0; ui_max = 1.0;
		ui_label = " ZPD缩放器²与入侵";
		ui_tooltip = "此选项提供额外的边界条件来缩放ZPD级别二。\n"
					 "让您调整检测屏幕后方入侵的距离。\n"
					 "仅在启用边界检测且设置了缩放器级别一时有效。";
		ui_category = "会聚";
	> = float2(OIF.x,DI_W.x);	
		...
		uniform float2 ZPD_Boundary_n_Cutoff_B <
			...
			ui_label = " ZPD缩放器³与入侵";
			ui_tooltip = "此选项提供额外的边界条件来缩放ZPD级别三。\n"
						 "让您调整检测屏幕后方入侵的距离。\n"
						 "仅在启用边界检测且设置了缩放器级别一时有效。";
			ui_category = "会聚";
		> = float2(OIF.y,DI_W.y);	
		...
		uniform float2 ZPD_Boundary_n_Cutoff_C <
			...
			ui_label = " ZPD缩放器4与入侵";
			ui_tooltip = "此选项提供额外的边界条件来缩放ZPD级别四。\n"
						 "让您调整检测屏幕后方入侵的距离。\n"
						 "仅在启用边界检测且设置了缩放器级别一时有效。";
			ui_category = "会聚";
		> = float2(OIF.z,DI_W.z);	
		...
		uniform float2 ZPD_Boundary_n_Cutoff_D <
			...
			ui_label = " ZPD缩放器5与入侵";
			ui_tooltip = "此选项提供额外的边界条件来缩放ZPD级别五。\n"
						 "让您调整检测屏幕后方入侵的距离。\n"
						 "仅在启用边界检测且设置了缩放器级别一时有效。";
			ui_category = "会聚";
		> = float2(OIF.w,DI_W.w);	
	...
	uniform int Performance_Level <
		ui_type = "combo";
		ui_items = "Performant\0正常\0Performant + VRS\0Normal + VRS\0";
		ui_label = " 性能级别";
	...
	uniform int Easy_SS_Scaling <
		...
		ui_type = "combo";	
		//ui_items = "关\0Quality           - Good\0Balanced          - Fair\0Performance       - Avoid\0Ultra Performance - Do Not Use\0";
		//ui_items = "关\0Ultra Quality     - Good\0Quality           - Good\0Balanced          - Fair\0Performance       - Avoid\0";	
		ui_items = "关\0[XeSS] Ultra Quality | [DLSS/FSR] Quality           \0[XeSS] Quality       | [DLSS/FSR] Balanced          \0[XeSS] Balanced      | [DLSS/FSR] Performance       \0[XeSS] Performance   | [DLSS/FSR] Ultra Performance \0";	
		ui_label = " 升频质量";
	...
	*/
	...
	uniform int Range_Boost <
		ui_type = "combo";
		ui_items = "关\0Offset Based\0Near Plane Based X1\0Near Plane Based X2\0Near Plane Based X3\0Near Plane Based X4\0";
		ui_label = " 深度增强范围";
	...
	uniform int Depth_Map_View <
		ui_type = "combo";
		ui_items = "关\0Stereo Depth View\0Normal Depth View\0";
		ui_label = " 深度图视图";
...
//		ui_items = "关\0Left\0中心\0Right\0Center Wide\0Left Wide\0Right Wide\0Eye Tracker\0Eye Tracker Alt\0";
	...
	uniform int FS_Mode <
		ui_type = "combo";
		ui_items = "关\0DLP Mode\0Blue Line FS\0Marked FS\0";
		ui_label = " 帧序列模式";
	...
	uniform int FPSDFIO <
		ui_type = "combo";
		ui_items = "关\0Press\0Hold\0Stencil\0Press & Stencil\0Hold & Stencil\0";
	...
	*/
	...
	uniform int Cursor_Type <
		ui_type = "combo";
		ui_items = "关\0Reticle\0Diamond\0Dot\0Cross\0Cursor\0";
