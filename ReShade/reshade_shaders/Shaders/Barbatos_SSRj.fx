...
uniform int ReflectionMode <
    ui_type = "combo";
    ui_items = "仅地面\0仅墙壁\0仅天花板\0地面和天花板\0所有表面\0";
    ui_category = "基础设置";
    ui_label = "反射表面";
    ui_tooltip = "选择哪些表面显示反射";
> = 4;
...
uniform float SurfaceSharpness <
    ...
    ui_category = "表面质量";
    ui_label = "表面锐度";
    ui_tooltip = "反射的清晰或模糊程度 (0=模糊, 1=锐利)";
> = 0.75;
...
uniform float MetallicLook <
    ...
    ui_category = "表面质量";
    ui_label = "金属质感";
    ui_tooltip = "使表面看起来更具金属感 (0=非金属, 1=金属)";
> = 0.2;
...
uniform float SurfaceDetails <
    ...
    ui_category = "表面质量";
    ui_min = 0.0; ui_max = 5.0; ui_step = 0.01;
    ui_tooltip = "为反射添加小的表面细节";
> = 0.1;

BLENDING_COMBO(g_BlendMode, "混合模式", "选择反射与场景的混合方式。", "颜色调整", false, 0, 0)
...
uniform float RenderResolution <
    ...
    ui_category = "性能";
    ui_label = "渲染分辨率";
    ui_tooltip = "值越低 = 性能越好但细节越少";
> = 0.8;

uniform bool EnableSmoothing <
    ui_category = "高级选项";
    ui_label = "减少反射噪点 (TAA)";
    ui_tooltip = "使用时间抗锯齿减少反射中的闪烁和噪点";
> = true;

uniform int SmartSurfaceMode <
    ui_type = "combo";
    ui_items = "关\0性能\0平衡\0质量\0";
    ui_category = "高级选项";
    ui_label = "智能表面检测";
    ui_tooltip = "法线平滑滤波器的质量。";
> = 1;
...
uniform float THICKNESS_THRESHOLD <
    ...
    ui_category = "高级选项";
    ui_label = "反射厚度阈值";
    ui_tooltip = "控制光线穿过表面之前的表面'厚度'。";
> = 0.009;

uniform int DebugView <
    ui_type = "combo";
    ui_items = "关\0仅反射\0表面法线\0深度视图\0运动\0";
    ui_category = "调试";
    ui_label = "调试视图";
    ui_tooltip = "特殊视图";
> = 0;
