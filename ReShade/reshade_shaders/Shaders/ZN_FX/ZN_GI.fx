...
uniform float NearPlane <
	...
	ui_max = 10.0;
	ui_label = "近平面";
	ui_tooltip = "调整深度缓冲的最小深度，如果看到暗线请稍微增加";
	ui_category = "深度缓冲设置";
> = 0.7;
...
uniform float AmbientNeg <
	...
	ui_max = 0.5;
	ui_label = "环境光偏移";
	ui_tooltip = "在应用GI之前移除环境光（仅适用于混合模式1）";
	ui_category = "显示";
> = 0.1;
...
uniform float LightEx <
	...
	ui_max = 2.2;
	ui_label = "光照指数";
	ui_tooltip = "将光照图转换为线性，如果启用效果后看到额外的色带，请稍微降低";
	ui_category = "显示";
> = 2.2;
...
uniform float distMask <
	ui_type = "slider";
	ui_label = "距离遮罩";
	ui_tooltip = "防止云彩过曝，减少雾气产生的伪影";
	ui_category = "显示";
> = 0.0;

uniform bool addR <
	ui_label = "叠加投射";
	ui_tooltip = "线性叠加采样而不是重置它们\n增加光线范围并显著提高着色质量 || 中等性能影响";
	ui_category = "采样";
> = 0;

uniform bool doDenoising <
	ui_label = "降噪";
	ui_tooltip = "运行高斯降噪通道 || 中等性能影响";
	ui_category = "采样";
> = 1;
...
uniform int sLod <
	...
	ui_max = 2;
	ui_label = "起始LOD";
	ui_tooltip = "更改起始LOD值，以牺牲细节为代价增加采样范围\n走样伪影可能非常明显 || 中等性能影响";
	ui_category = "采样";
> = 0;
...
uniform float LigM <
	...
	ui_max = 1.0;
	ui_label = "亮度强度";
	ui_tooltip = "光源的指数。增加'光线范围'时建议降低 || 无性能影响";
	ui_category = "采样";
> = 1.0;
...
uniform float disD <
	...
	ui_max = 2.0;
	ui_label = "距离强度";
	ui_tooltip = "修改物理定律，2是物理准确的 || 无性能影响";
	ui_category = "采样";
> = 2.0;
...
uniform float sampR <
	...
	ui_max = 20.0;
	ui_label = "光线范围";
	ui_tooltip = "增加GI范围而不损失细节，较高级别可能产生噪点 || 低性能影响";
	ui_category = "采样";
> = 7.0;
