...
uniform float AO_TEXSCALE <
    ui_label = "缩放";
    ui_category = "全局参数";
    ui_tooltip = "AO分辨率缩放，1.0表示全屏。较低分辨率意味着处理更少像素，性能更好但质量也更低。";
    ui_type = "slider";
    ui_min = 0.25;
    ui_max = 1.0;
    ui_step = 0.01;
...
uniform bool AO_SHARPNESS_DETECT <
    ui_label = "锐度检测";
    ui_category = "全局参数";
    ui_tooltip = "AO不应模糊物体边缘。关：通过深度检测边缘（旧方法）开：通过法线检测边缘（新方法）。新方法效果更好但可能产生一些黑色轮廓。";
> = 1;

uniform int AO_BLUR_STEPS <
    ui_label = "模糊步数";
    ui_category = "全局参数";
    ui_tooltip = "AO平滑的偏移计数。较高值意味着AO更平滑但也更模糊。";
    ui_type = "slider";
    ui_min = 5;
    ui_max = 15;
    ui_step = 1;
...
uniform int AO_DEBUG <
    ui_label = "调试";
    ui_type = "combo";
    ui_items = "关闭调试\0环境光遮蔽调试\0全局光照调试\0";
    ui_category = "全局参数";
    ui_tooltip = "调试模式选择。可以查看AO效果或GI效果。";
> = 0;
...
uniform float AO_FADE_START <
    ui_label = "淡出起点";
    ui_category = "全局参数";
    ui_tooltip = "AO开始淡出的距摄像机距离。0.0表示摄像机本身，1.0表示无限远。";
    ui_type = "slider";
    ui_min = 0.0;
    ui_max = 1.0;
    ui_step = 0.001;
...
uniform float AO_FADE_END <
    ui_label = "淡出终点";
    ui_category = "全局参数";
    ui_tooltip = "AO完全淡出的距摄像机距离。0.0表示摄像机本身，1.0表示无限远。";
    ui_type = "slider";
    ui_min = 0.0;
    ui_max = 1.0;
    ui_step = 0.001;
...
uniform int iSSAOSamples <
    ui_label = "SSAO采样数";
    ui_category = "SSAO设置";
    ui_tooltip = "采样数量。不要设置太高否则着色器编译时间会急剧增加。";
    ui_type = "slider";
    ui_min = 16;
    ui_max = 128;
    ui_step = 8;
...
uniform float fSSAOSamplingRange <
    ui_label = "SSAO采样范围";
    ui_category = "SSAO设置";
    ui_tooltip = "SSAO采样范围。较高的范围值可能需要更多采样，因此请同时提高两者。";
    ui_type = "slider";
    ui_min = 10.0;
    ui_max = 50.0;
    ui_step = 0.1;
...
uniform int iRayAOSamples <
    ui_label = "光线AO采样数";
    ui_category = "光线追踪AO设置";
    ui_tooltip = "采样\"射线\"数量。较高意味着AO更准确但性能也更低。";
    ui_type = "slider";
    ui_min = 10;
    ui_max = 78;
    ui_step = 1;
...
uniform float fRayAOSamplingRange <
    ui_label = "光线AO采样范围";
    ui_category = "光线追踪AO设置";
    ui_tooltip = "AO采样范围。较高值忽略小几何细节并产生更全局的阴影。";
    ui_type = "slider";
    ui_min = 0.001;
    ui_max = 0.025;
    ui_step = 0.001;
...
uniform float fRayAOMaxDepth <
    ui_label = "光线AO最大深度";
    ui_category = "光线追踪AO设置";
    ui_tooltip = "防止远处物体仅因为在屏幕上相邻就遮挡近处物体的系数。";
    ui_type = "slider";
    ui_min = 0.01;
    ui_max = 0.02;
    ui_step = 0.001;
...
uniform float fRayAOMinDepth  <
    ui_label = "光线AO最小深度";
    ui_category = "光线追踪AO设置";
    ui_tooltip = "最小深度差截止值，防止（几乎）平坦表面自遮挡。";
    ui_type = "slider";
    ui_min = 0.001;
    ui_max = 0.02;
    ui_step = 0.001;
...
uniform int iHBAOSamples <
    ui_label = "HBAO采样数";
    ui_category = "HBAO设置";
    ui_tooltip = "采样数量。较高意味着AO更准确但性能也更低。";
    ui_type = "slider";
    ui_min = 7;
    ui_max = 36;
    ui_step = 1;
...
uniform float fHBAOSamplingRange  <
    ui_label = "HBAO采样范围";
    ui_category = "HBAO设置";
    ui_tooltip = "HBAO采样范围。较高值忽略小几何细节并产生更全局的阴影。";
    ui_type = "slider";
    ui_min = 0.5;
    ui_max = 5.0;
    ui_step = 0.001;
...
uniform float fHBAOClamp  <
    ui_label = "HBAO钳制";
    ui_category = "HBAO设置";
    ui_tooltip = "钳制HBAO强度。0.0表示全强度，1.0表示无HBAO。";
    ui_type = "slider";
    ui_min = 0.0;
    ui_max = 1.0;
    ui_step = 0.001;
...
uniform float fHBAOAttenuation  <
    ui_label = "HBAO衰减";
    ui_category = "HBAO设置";
    ui_tooltip = "影响HBAO范围，防止对屏幕空间相近但实际距离很远的物体产生阴影。";
    ui_type = "slider";
    ui_min = 0.001;
    ui_max = 0.2;
    ui_step = 0.001;
...
uniform int iSSGISamples <
    ui_label = "SSGI采样数";
    ui_category = "SSGI设置";
    ui_tooltip = "SSGI采样迭代次数，较高意味着GI效果更好但性能更低。";
    ui_type = "slider";
    ui_min = 5;
    ui_max = 24;
    ui_step = 1;
...
uniform float fSSGIIlluminationMult <
    ui_label = "SSGI光照倍增";
    ui_category = "SSGI设置";
    ui_tooltip = "SSGI光照（颜色反弹/反射）的倍增器。";
    ui_type = "slider";
    ui_min = 1.0;
    ui_max = 8.0;
    ui_step = 0.001;
...
uniform float fSSGIModelThickness <
    ui_label = "SSGI模型厚度";
    ui_category = "SSGI设置";
    ui_tooltip = "算法假设模型厚度的单位空间数。如果场景只包含小物体，请降低此值。";
    ui_type = "slider";
    ui_min = 0.5;
    ui_max = 100.0;
    ui_step = 0.001;
...
uniform float fSAOClamp <
    ui_label = "SAO钳制";
    ui_category = "SAO设置";
    ui_tooltip = "较高值将AO更多地向黑色偏移。对于因高SAO半径导致的浅灰色AO很有用。";
    ui_type = "slider";
    ui_min = 1.0;
    ui_max = 10.0;
    ui_step = 0.001;
...
uniform float fSAORadius <
    ui_label = "SAO半径";
    ui_category = "SAO设置";
    ui_tooltip = "SAO采样半径。较高值也会极大降低AO强度，因为Alchemy的衰减公式非常糟糕。";
    ui_type = "slider";
    ui_min = 1.0;
    ui_max = 10.0;
    ui_step = 0.001;
...
uniform float fSAOBias <
    ui_label = "SAO偏移";
    ui_category = "SAO设置";
    ui_tooltip = "AO考量的最小表面角度。用于防止因浮点精度问题导致的平坦表面自遮挡。";
    ui_type = "slider";
    ui_min = 0.001;
    ui_max = 0.5;
    ui_step = 0.001;
