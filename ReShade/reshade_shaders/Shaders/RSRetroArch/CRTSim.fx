...
uniform float NTSCLerp <
	...
	ui_max = 1.0;
	ui_step = 0.001;
	ui_label = "NTSC扫描线 [CRT-Sim]";
> = 1.0;

uniform bool animate_artifacts <
	ui_type = "boolean";
	ui_label = "动态伪影 [CRT-Sim]";
> = true;
