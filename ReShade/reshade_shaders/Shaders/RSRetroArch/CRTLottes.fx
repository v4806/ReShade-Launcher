...
uniform float shape <
	...
	ui_step = 0.05;
	ui_tooltip = "滤镜核形状 [CRT-Lottes]";
> = 2.0;

uniform bool doBloom <
	ui_tooltip = "泛光 [CRT-Lottes]";
> = 1;
