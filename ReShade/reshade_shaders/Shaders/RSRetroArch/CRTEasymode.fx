...
uniform float SCANLINE_BEAM_WIDTH_MIN <
	...
	ui_max = 5.0;
	ui_step = 0.5;
	ui_label = "扫描线束宽度最小值 [CRT-Easymode]";
> = 1.5;
...
uniform float SCANLINE_BEAM_WIDTH_MAX <
	...
	ui_max = 5.0;
	ui_step = 0.5;
	ui_label = "扫描线束宽度最大值 [CRT-Easymode]";
> = 1.5;
...
uniform float SCANLINE_BRIGHT_MIN <
	...
	ui_max = 1.0;
	ui_step = 0.05;
	ui_label = "扫描线亮度最小值 [CRT-Easymode]"; 
> = 0.35;
...
uniform float SCANLINE_BRIGHT_MAX <
	...
	ui_max = 1.0;
	ui_step = 0.05;
	ui_label = "扫描线亮度最大值 [CRT-Easymode]";
> = 0.65;
...
uniform bool ENABLE_LANCZOS <
	ui_type = "combo";
	ui_label = "启用Lanczos [CRT-Easymode]";
> = true;
