...
uniform float fNoiseIntensity <
	...
	ui_max = 1.0;
	ui_step = 0.001;
	ui_label = "噪点强度 [MetaCRT]";
> = 0.0;

uniform bool bScanlineInterference <
	ui_label = "启用扫描线干扰 [MetaCRT]";
> = false;
...
uniform int fVerticalLines <
	...
	ui_max = BUFFER_HEIGHT;
	ui_step = 1.0;
	ui_label = "垂直线数量 [Meta CRT]";
	ui_tooltip = "用于扫描线干扰。建议设置为宽度值+3";
> = 483;

uniform bool bBorders <
	ui_label = "启用边框 [MetaCRT]";
> = true;

uniform bool bZoom <
	ui_label = "启用鼠标缩放 [MetaCRT]";
> = true;
