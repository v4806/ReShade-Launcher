...
uniform int PIXELSIZE <
	...
	ui_min = 1;
	ui_max = 20;
	ui_label = "像素大小 [DOSGame]";
	ui_step = 1;
> = 2;

uniform bool ENABLE_SCREENSIZE <
	ui_type = "boolean";
	ui_label = "使用绝对分辨率 [DOSGame]";
> = true;
...
uniform int2 DOSScreenSize <
	...
	ui_max = 99999;
	ui_step = 1;
	ui_label = "屏幕分辨率 [DOSGame]";
> = int2(320,240);

uniform bool DOSCOLOR <
	ui_type = "boolean";
	ui_label = "启用色带 [DOSGame]";
> = true;
...
uniform int DOSColorsCount <
	...
	ui_max = 255;
	ui_step = 1;
	ui_label = "颜色数量 [DOSGame]";
> = 16;

uniform bool ENABLE_POSTCURVE <
	ui_type = "boolean";
	ui_label = "启用亮度曲线 [DOSGame]";
> = true;
...
uniform float POSTCURVE <
	...
	ui_max = 5.0;
	ui_step = 0.001;
	ui_label = "曲线调整 [DOSGame]";
> = 0.5;

uniform bool ENABLE_AGD <
	ui_type = "boolean";
	ui_label = "启用伽马调整 [DOSGame]";
> = true;
