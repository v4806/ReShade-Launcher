...
uniform float CRTS_WARP_X <
	...
	ui_min = 0.0;
	ui_max = 512.0;
	ui_label = "CRT弯曲X [CRT Lottes 2.0]";
> = 64.0;
...
uniform float CRTS_WARP_Y <
	...
	ui_min = 0.0;
	ui_max = 512.0;
	ui_label = "CRT弯曲Y [CRT Lottes 2.0]";
> = 48.0;

uniform bool CRTS_TONE <
	ui_type = "boolean";
	ui_label = "启用CRT色调映射 [CRT Lottes 2.0]";
> = true;

uniform bool CRTS_CONTRAST <
	ui_type = "boolean";
	ui_label = "启用CRT对比度 [CRT Lottes 2.0]";
> = false;

uniform bool CRTS_SATURATION <
	ui_type = "boolean";
	ui_label = "启用CRT饱和度 [CRT Lottes 2.0]";
> = false;

uniform int CRTS_MASK_TYPE <
	ui_type = "combo";
	ui_items = "无\0光栅栅格\0光栅栅格 (轻量)\0阴影遮罩\0";
	ui_label = "遮罩类型 [CRT Lottes 2.0]";
> = 2;
...
uniform float INPUT_BLUR <
	...
	ui_min = -3.0;
	ui_max = 0.0;
	ui_label = "水平扫描模糊 [CRT Lottes 2.0]";
> = -2.5;
...
uniform float INPUT_MASK <
	...
	ui_min = 0.0;
	ui_max = 1.0;
	ui_label = "阴影遮罩强度 [CRT Lottes 2.0]";
> = 0.5;
