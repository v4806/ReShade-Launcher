...
uniform float CURVE <
	...
	ui_max = 30.0;
	ui_step = 0.001;
	ui_label = "曲率 [VT220 Term]";
> = 3.0;

uniform float3 BEZEL_COL <
	ui_type = "color";
	ui_label = "边框颜色 [VT220 Term]";
> = float3(0.8, 0.8, 0.6);

uniform float3 PHOSPHOR_COL <
	ui_type = "color";
	ui_label = "荧光粉颜色 [VT220 Term]";
> = float3(0.2, 1.0, 0.2);
