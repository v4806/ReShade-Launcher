...
uniform float texture_sizeY <
	...
	ui_label = "扫描线高度 [Scanlines-Absolute]";
> = 240.0;
...
uniform float amp <
	...
	ui_max = 2.0;
	ui_step = 0.05;
	ui_label = "振幅 [Scanlines-Absolute]";
> = 1.25;
...
uniform float phase <
	...
	ui_max = 2.0;
	ui_step = 0.05;
	ui_label = "相位 [Scanlines-Absolute]";
> = 0.0;
...
uniform float lines_black <
	...
	ui_max = 1.0;
	ui_step = 0.05;
	ui_label = "线条黑电平 [Scanlines-Absolute]";
> = 0.0;
...
uniform float lines_white <
	...
	ui_max = 2.0;
	ui_step = 0.05;
	ui_label = "线条白电平 [Scanlines-Absolute]";
> = 1.0;
...
float4 PS_ScanlinesAbs(float4 pos : SV_POSITION, float2 tex : TEXCOORD0, float angle : TEXCOORD2) : SV_TARGET 
{
	...
	angle = tex.y * omega * texture_sizeY + phase;
