...
uniform float interlace_toggle <
	...
	ui_max = 5.0;
	ui_step = 4.0;
	ui_label = "隔行扫描 [CRT-Geom]";
> = 1.0;

uniform bool OVERSAMPLE <
	ui_tooltip = "启用3倍过采样光束剖面；改善扫描线+曲率导致的摩尔纹效果";
> = true;

uniform bool INTERLACED <
	ui_tooltip = "使用隔行检测；与其他着色器组合时可能产生干扰";
> = true;
