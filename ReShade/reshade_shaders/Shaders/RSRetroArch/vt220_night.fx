...
uniform int charX <
	...
	ui_max = BUFFER_WIDTH;
	ui_step = 1;
	ui_label = "字符宽度 [VT220 Term Night]";
> = 80;
...
uniform int charY <
	...
	ui_step = 1;
	ui_label = "字符高度 [VT220 Term Night]";
> = 24;
...
uniform int MAIN_BLOOM_ITERATIONS <
	...
	ui_max = 255;
	ui_step = 1;
	ui_label = "泛光迭代次数 [VT220 Term Night]";
> = 10;
...
uniform float MAIN_BLOOM_SIZE <
	...
	ui_max = 1.0;
	ui_step = 0.001;
	ui_label = "泛光大小 [VT220 Term Night]";
> = 0.01;
...
uniform int REFLECTION_BLUR_ITERATIONS <
	...
	ui_max = 255;
	ui_step = 1;
	ui_label = "反射模糊迭代次数 [VT220 Term Night]";
> = 10;
...
uniform float REFLECTION_BLUR_SIZE<
	...
	ui_max = 1.0;
	ui_step = 0.001;
	ui_label = "反射模糊大小 [VT220 Term Night]";
> = 0.05;
...
uniform float CURVE <
	...
	ui_max = 30.0;
	ui_step = 0.001;
	ui_label = "曲率 [VT220 Term Night]";
> = 3.0;

uniform float3 BEZEL_COL <
	ui_type = "color";
	ui_label = "边框颜色 [VT220 Term Night]";
> = float3(0.8, 0.8, 0.6);

uniform float3 PHOSPHOR_COL <
	ui_type = "color";
	ui_label = "荧光粉颜色 [VT220 Term Night]";
> = float3(0.2, 1.0, 0.2);
