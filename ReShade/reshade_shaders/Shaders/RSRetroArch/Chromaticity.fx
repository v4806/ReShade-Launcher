...
uniform float CHROMA_A_WEIGHT <
	...
	ui_max = 1.0;
	ui_step = 0.01;
	ui_label = "色度 R 亮度权重 [Chromaticity]";
> = 0.299;
...
uniform float CHROMA_B_WEIGHT <
	...
	ui_max = 1.0;
	ui_step = 0.01;
	ui_label = "色度 G 亮度权重 [Chromaticity]";
> = 0.587;
...
uniform float CHROMA_C_WEIGHT <
	...
	ui_max = 1.0;
	ui_step = 0.01;
	ui_label = "色度 B 亮度权重 [Chromaticity]";
> = 0.114;
...
uniform float CRT_TR2 <
	...
	ui_max = 5.0;
	ui_step = 0.05;
	ui_label = "传递函数 (2) [Chromaticity]";
> = 4.5;

uniform bool SCALE_W <
	ui_type = "bool";
	ui_label = "缩放白点 [Chromaticity]";
> = true;
