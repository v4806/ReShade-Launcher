...
uniform float rgbShift <
	...
	ui_max = 1.0;
	ui_step = 0.001;
	ui_label = "RGB偏移 [CoolRetroTerm]";
> = 0.0;

uniform int rasterization <
	ui_type = "combo";
	ui_items = "默认\0扫描线\0像素\0";
	ui_label = "光栅化 [CoolRetroTerm]";
> = 0;
