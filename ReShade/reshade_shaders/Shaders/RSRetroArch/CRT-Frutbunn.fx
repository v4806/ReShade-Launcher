...
uniform float texture_sizeY <
	...
	ui_label = "屏幕高度 [CRT-Frutbunn]";
> = 240.0;

uniform bool CURVATURE <
	ui_type = "boolean";
	ui_label = "曲率开关 [CRT-Frutbunn]";
> = true;

uniform bool SCANLINES <
	ui_type = "boolean";
	ui_label = "扫描线开关 [CRT-Frutbunn]";
> = true;

uniform bool CURVED_SCANLINES <
	ui_type = "boolean";
	ui_label = "扫描线曲线开关 [CRT-Frutbunn]";
> = true;

uniform bool LIGHT <
	ui_type = "boolean";
	ui_label = "暗角开关 [CRT-Frutbunn]";
> = true;
