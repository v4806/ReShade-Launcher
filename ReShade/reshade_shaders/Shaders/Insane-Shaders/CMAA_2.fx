...
uniform int UIHELP <
	...
	ui_category = "帮助";
	ui_label = "    ";
    ui_text =  "CMAA2_EXTRA_SHARPNESS - 此设置使AA效果整体更锐利\n"
			   "可以是0或1。（默认为0（关闭）） \n\n"
			   "CMAA2_STATIC_QUALITY_PRESET - 此设置范围为0到4，调整边缘检测强度，"
		   	   "更高的设置会带来性能开销\n"
			   "0 - 低, 1 - 中, 2 - 高, 3 - 超高, 4 - 极限 (默认为2)";
...
uniform int UIHELP <
    ...
    ui_text =  "CMAA2_EXTRA_SHARPNESS - 此设置使AA效果整体更锐利\n"
			   "可以是0或1。（默认为0（关闭））\n\n"
			   "CMAA2_PERFORMANCE_HACK - 此设置启用性能优化，以轻微的质量损失\n"
			   "大幅提升AA性能。\n"
			   "可以是0或1。（默认为1（开启））\n\n"
			   "CMAA2_STATIC_QUALITY_PRESET - 此设置范围为0到4，调整边缘检测强度，\n"
		   	   "更高的设置会带来性能开销\n"
...
technique CMAA_2 < ui_tooltip = "Intel CMAA 2.0（保守形态抗锯齿）的ReShade移植版\n\n"
								  "移植至ReShade: Lord Of Lunacy";>
{
	pass
	{
