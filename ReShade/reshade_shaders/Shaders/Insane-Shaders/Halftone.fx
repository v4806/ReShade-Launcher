...
uniform float KStrength<
		ui_type = "slider";
		ui_label = "K强度";
		ui_tooltip = "更改用于从彩色网点中减去的K（黑色）量。";
		ui_min = 0; ui_max = 1;
		ui_step = 0.001;
> = 0.5;
...
uniform float Angle<
	ui_type = "slider";
	ui_label = "角度";
	ui_tooltip = "更改网点排列的角度，有助于减少走样图案。";
	ui_min = 0; ui_max = 1;
	ui_step = 0.001;
> = 0.33;
...
technique Halftone <ui_tooltip = "此着色器模拟胶印中常见的CMYK半调效果，\n"
								   "使图像产生类似印刷品的效果。\n\n"
								   "Insane Shaders的一部分\n"
								   "作者: Lord Of Lunacy";>
{
