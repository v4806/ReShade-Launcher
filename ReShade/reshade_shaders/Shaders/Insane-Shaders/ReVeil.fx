...
uniform float DepthMultiplier<
	...
	ui_label = "深度敏感度";
	ui_category = "通用设置";
	ui_tooltip = "调整去雾受深度影响的程度，\n"
				"正值会为场景添加雾气。0表示不受深度影响。";
	ui_min = -1; ui_max = 1;
	ui_step = 0.001;
> = -0.075;
	...
	uniform float VarianceCutoff<
		...
		ui_label = "方差阈值";
		ui_category = "可变速率图";
		ui_tooltip = "使用此选项调整ReVeil停止查找雾气的方差级别（调试视图中雾气应显示为绿色）";
	...
	uniform bool UseVRS<
		ui_label = "实验性可变速率图支持";
		ui_category = "可变速率图";
		ui_tooltip = "使用此选项允许ReVeil使用可变速率图（必须启用VariableRateShading才能生效）";
	> = false;

	uniform int Debug <
		ui_type = "combo";
		ui_items = "无\0透射图\0可变速率图\0";
		ui_label = "调试视图";
		ui_category = "调试";
	> = 0;
#else
...
technique ReVeil_Top <ui_tooltip = "将此放在您想要应用ReVeil的任何着色器之上。\n\n"
								  "（如果看起来没有任何效果，请不要担心，此处的操作在应用ReVeil_Bottom之前不会生效）\n\n"
								  "Insane Shaders的一部分\n"
								  "作者: Lord of Lunacy";>
{
#if REVEIL_COMPUTE == 1
...
technique ReVeil_Bottom <ui_tooptip = "将此放在您想要应用ReVeil的着色器之下。";>
{
