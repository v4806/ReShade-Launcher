...
namespace Oilify
{
	...
	uniform float Sharpness<
		ui_type = "slider";
		ui_label = "锐度";
		ui_tooltip = "较高的设置会产生更锐利的图像，较低的值会\n"
					"使图像看起来更简化。";
		ui_min = 0; ui_max = 1;
		ui_step = 0.001;
	> = 1;
	...
	uniform float Tuning<
		ui_type = "slider";
		ui_label = "各向异性调节";
		ui_tooltip = "调整采样可以变得多椭圆\n"
					"较小的数字意味着更椭圆。（如果着色器看起来被拉伸，请使用此选项）";
		ui_min = 0; ui_max = 4;
	> = 2;
	...
	technique Oilify<ui_tooltip = "Oilify是各向异性Kuwahara滤波器的改进版本，\n"
							  "用于创建油画效果。\n\n"
							  "Insane Shaders的一部分\n"
							  "作者: Lord of Lunacy\n\n"
							  "OILIFY_SIZE: 更改使用的滤波器大小。\n"
							  "OILIFY_ITERATIONS: 范围从1到8。";>
	{
		pass
		{
			VertexShader = PostProcessVS;
