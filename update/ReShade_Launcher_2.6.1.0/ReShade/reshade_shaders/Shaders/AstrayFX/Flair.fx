...
uniform int Flare_Type <
    ui_type = "combo";
    ui_items = "完整星形\0半星形\0十字形 +\0十字形 x\0耀斑正倾斜\0耀斑负倾斜\0耀斑水平\0耀斑垂直\0";
    ui_label = "耀斑类型";
    ui_category = "耀斑类型";
> = 0;
...
uniform float Flare_Clamp_A <
	...
	ui_label = "耀斑亮度阈值";
	ui_tooltip = "使用此项设置基于颜色的亮度阈值，决定哪些被允许哪些不被允许。\n"
				 "默认值为1.0。";
	ui_category = "耀斑调整";
> = 1.0;
...
uniform float Flare_Spread <
	...
	ui_label = "耀斑扩散";
	ui_tooltip = "使用此项调整耀斑大小，你可以覆盖此设置。\n"
				 "默认值为0.5。";
	ui_category = "耀斑调整";
> = 0.5;
...
uniform int Flare_Color_Map <
	...
	ui_min = -1; ui_max = 8;
	ui_label = "耀斑颜色映射";
	ui_tooltip = "使用此项设置用于耀斑颜色的颜色映射的MIP级别。\n"
				 "这会在一般区域采样颜色以实现此效果。\n"
								"默认值为4，零为关闭。";
	ui_category = "耀斑调整";
> = 4;
...
uniform int CA_Type <
    ui_type = "combo";
    ui_items = "关\0BD类型\0盒状\0水平\0垂直\0";
    ui_label = "耀斑色差类型";
	ui_category = "耀斑色差";
> = 1;
