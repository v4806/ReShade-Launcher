...
uniform float Clamping_Adjust <
	...
	ui_min = 0; ui_max = 1.0;
	ui_label = "钳制调整";
	ui_tooltip = "调整影响模糊的钳制。\n"
				 "默认值为零。";
	ui_category = "TAA时间抗锯齿";
> = 0.0;
...
uniform float Similarity <
	...
	ui_label = "深度相似性";
	ui_tooltip = "基于过去和当前深度之间的深度相似性进行额外的图像钳制以消除TAA鬼影。\n"
				 "在选择深度和颜色增量且游戏中深度有效时工作。\n"
				 "默认值为0.25。";
	ui_category = "TAA时间抗锯齿";
> = 0.25;
...
uniform float Delta_Power <
	...
	ui_label = "颜色与深度增量强度";
	ui_tooltip = "基于过去和当前深度缓冲之间的增量进行额外的图像钳制。\n"
				 "仅在选择深度增量且游戏中深度有效时工作。\n"
				 "默认值为0.25。";
	ui_category = "TAA时间抗锯齿";
> = 0.25;
...
uniform int Debug <
	ui_type = "combo";
	ui_items = "TAA时间抗锯齿\0增量钳制\0消除鬼影遮罩\0深度\0";
	ui_label = "调试视图";
> = 0;
