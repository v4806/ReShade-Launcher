...
uniform int Auto_Bloom <
	ui_type = "combo";
	ui_label = "自动泛光";
	ui_items = "关\0自动强度\0自动去饱和\0自动饱和\0自动强度与去饱和\0自动强度与饱和\0";
	ui_tooltip = "自动强度将使着色器通过上方的泛光不透明度自动调整泛光强度。\n"
				"自动饱和将使着色器通过上方的泛光饱和度自动调整泛光饱和度。\n"
				"默认为关闭。";
	ui_category = "泛光调整";
> = 0;
...
uniform float CBT_Adjust <
	...
	ui_label = "提取明亮颜色";
	ui_tooltip = "用于设置基于颜色的亮度阈值来确定允许和不允许的内容。\n"
				"这是最重要的设置，使用调试视图来调整。\n"
				"默认值为0.5。";
	ui_category = "泛光调整";
> = 0.5;
...
uniform float2 Bloom_Intensity<
	...
	#endif
	ui_min = 0.0; ui_max = 1.0;
		ui_label = "泛光强度与泛光不透明度";
	ui_tooltip = "用于设置主要和次要泛光强度以及整体泛光不透明度。\n"
				//"第二个选项仅在上方设置泛光强度隔离时有效。\n"
				"默认值为0.1和0.5。";
	ui_category = "泛光调整";
> = float2(0.1,0.5);
...
uniform float2 Saturation <
	...
	#endif
	ui_min = 0.0; ui_max = 1.0;
	ui_label = "泛光饱和度与自动截止点";
	ui_tooltip = "调整泛光饱和度的量。\n"
				"两者默认值均为0.25。";
	ui_category = "泛光调整";
> = float2(0.25,0.25);
...
uniform float GreyValue <
    ...
    ui_label = "曝光50%灰度值";
    ui_tooltip = "曝光50%灰度值，使用ACES Fitted时设置较高，使用Timothy时设置较低。";
    ui_category = "色调映射调整";
> = 0.128;
...
uniform float Gamma <
	...
	ui_label = "伽马值";
	ui_tooltip = "大多数显示器/图像使用2.2的值。设置为1可禁用从伽马到线性的初始色彩空间转换。";
	ui_category = "色调映射调整";
> = 2.2;
...
uniform float HDR_BP <
	...
	ui_min = 0.0; ui_max = 1.0;
	ui_label = "HDR强度";
	ui_tooltip = "用于调整HDR强度，你可以覆盖此值并设置为1.5或其他值。\n"
				"默认值为0.5。";
	ui_category = "高动态范围";
> = 0.5;
...
uniform bool Bloom_BA_iToneMapper <
	ui_label = "HDR泛光应用";
	ui_tooltip = "此选项允许你在HDR色调映射器之前和之后之间切换。";
	ui_category = "高动态范围";
> = 0;
...
uniform int Auto_Exposure <
	ui_type = "combo";
	ui_label = "自动曝光类型";
	ui_items = "关\0自动曝光与眼睛适应\0自动曝光与眼睑适应\0";
	ui_tooltip = "启用着色器自动调整曝光。\n"
				 "这也会为此着色器开启眼睛适应。\n"
				 "基于Prod80的自动曝光算法移植。\n"
				 "Padraic Hennessy, MJP 和 David Neubelt。";
	ui_category = "适应";
> = 1;
...
uniform int Debug_View <
	ui_type = "combo";
	ui_label = "调试视图";
	ui_items = "正常视图\0泛光视图\0热力图\0";
	ui_tooltip = "用于查看游戏、电影画面等的着色和模糊效果。";
	ui_category = "调试";
> = 0;
