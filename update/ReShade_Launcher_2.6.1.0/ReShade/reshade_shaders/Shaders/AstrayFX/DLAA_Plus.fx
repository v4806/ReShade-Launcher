...
uniform int View_Mode <
	ui_type = "combo";
	ui_items = "DLAA\0DLAA文字保护\0蓝色短边H/V AA遮罩\0红色H与绿色V长边缘遮罩\0文字保护遮罩\0";
	ui_label = "视图模式";
	ui_tooltip = "用于选择正常视图输出或调试视图。";
	ui_category = "DLAA调试";
> = 0;
