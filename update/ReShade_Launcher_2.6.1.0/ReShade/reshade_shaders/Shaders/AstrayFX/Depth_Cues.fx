...
uniform bool DEPTH_DEBUG <
	ui_label = "查看深度";
	ui_tooltip = "显示深度，你希望近处物体为黑色，远处物体为白色以使效果正常工作。";
	ui_category = "深度缓冲";
> = false;

uniform bool No_Depth_Map <
	ui_label = "无深度图";
	ui_tooltip = "如果你没有深度缓冲，请开启此选项。";
	ui_category = "深度缓冲";
> = true;
...
uniform float Shade_Power <
	...
	ui_label = "阴影强度";
	ui_tooltip = "调整阴影强度，这可以改善游戏中的AO、阴影和暗部区域。\n"
				 "默认值为0.5。";
	ui_category = "深度线索";
> = 0.5;
...
uniform float Spread <
	...
	ui_label = "阴影填充";
	ui_tooltip = "调整此值使阴影效果填充区域，产生伪AO效果。\n"
				 "用于填补空隙。\n"
				 "默认值为10.0。";
	ui_category = "深度线索";
> = 10.0;
