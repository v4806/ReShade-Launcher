...
< __UNIFORM_SLIDER_INT1
	ui_min = 1; ui_max = 4;
	ui_label = "模糊半径";
	ui_tooltip = "1 = 3x3遮罩，2 = 5x5遮罩，3 = 7x7遮罩，4 = 9x9遮罩。如需更强的模糊效果，请在预处理器定义中添加SurfaceBlurIterations=2或SurfaceBlurIterations=3";
> = 1;
...
< __UNIFORM_SLIDER_FLOAT1
	...
	ui_label = "模糊偏移";
	ui_tooltip = "模糊半径的额外调整。小于1.00的值将减小模糊半径。";
> = 1.000;
...
< __UNIFORM_SLIDER_FLOAT1
	...
	ui_label = "边缘检测";
	ui_tooltip = "调整边缘检测的强度。较低的值将从模糊中排除更细微的边缘。";
> = 0.500;
