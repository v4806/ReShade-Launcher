...
uniform int Mode <
	ui_type = "combo";
	ui_label = "模式";
	ui_items = "仅亮度\0仅色度\0亮度和色度\0";
	ui_tooltip = "选择对比度应用于哪个通道。";
> = 0;
uniform int Formula <
	ui_type = "combo";
	ui_label = "曲线公式";
	ui_items = "正弦\0绝对值分离\0平滑阶跃\0指数公式\0简化Catmull-Rom(0,0,1,1)\0Perlin平滑阶跃\0绝对值相加\0Technicolor电影风格\0抛物线\0半圆\0多项式分离\0";
	ui_tooltip = "选择要使用的对比度S曲线。注意Technicolor电影风格与正弦几乎相同，但运行较慢。实际上差异可能只是舍入误差。我个人偏好2，但3是一个不错的替代选择，效果略强（但对高光和阴影更苛刻），而且是最快的公式。";
> = 4;
