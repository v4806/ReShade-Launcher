...
uniform int DebugEnabled <
    ui_type = "combo";
    ui_label = "启用调试视图";
    ui_items = "已禁用\0模糊后\0模糊前\0";
> = 0;

uniform int Bilateral <
    ui_type = "combo";
    ui_label = "伪双边滤波\n推荐：禁用可获得最高性能，水平优先可获得更好质量";
    ui_items = "禁用（更快，更模糊）\0垂直优先\0水平优先\0";
> = 2;
...
uniform float NormalPower <
		...
		ui_label = "法线强度";
        ui_tooltip = "类似于法线偏移的更柔和版本，但没有阈值\n推荐值：1.4";
> = 1.4;
...
uniform int FOV <
		...
		ui_label = "视场角";
        ui_tooltip = "无论实际FOV如何保持90都能获得可接受的结果";
> = 90;
